	...
	for (var i=1;i<=this.nb;i++)
	{
		...
		if ((document.all)||(window.sidebar)||(!document.layers))
		{
			...
			if(this.vert)
			{
				if (this.MnuImgFond!="")
				{
					A+="<DIV id='"+this.nom+i+"' style='position:absolute;left:"+X+";top:"+Y+";"+style+"width:"+this[i].larg+";height:"+this[i].hauteur+";background-color:"+this.colBarre+";"+this.cssTexte+";color:"+this.colTextOff+";text-align:left;background-image:url("+this.RepertoireImage+this.MnuImgFond+");background-repeat:repeat-x;' onmouseover='"+this.nom+".start("+i+","+(X+this[i].larg+1)+","+Y+")'"+clic+">"+this[i].txt+"</DIV>";
				}
				else
				{
					A+="<DIV id='"+this.nom+i+"' style='position:absolute;left:"+X+";top:"+Y+";"+style+"width:"+this[i].larg+";height:"+this[i].hauteur+";background-color:"+this.colBarre+";"+this.cssTexte+";color:"+this.colTextOff+";text-align:left;' onmouseover='"+this.nom+".start("+i+","+(X+this[i].larg+1)+","+Y+")'"+clic+">"+this[i].txt+"</DIV>";
				}
			}
			else
			{
				if (this.MnuImgFond!="")
				{
					A+="<DIV id='"+this.nom+i+"' style='position:absolute;left:"+X+";top:"+Y+";"+style+"width:"+this[i].larg+";height:"+this[i].hauteur+";background-color:"+this.colBarre+";"+this.cssTexte+";color:"+this.colTextOff+";text-align:center;background-image:url("+this.RepertoireImage+this.MnuImgFond+");background-repeat:repeat-x;' onmouseover='"+this.nom+".start("+i+","+X+","+(Y+this[i].hauteur+1)+")'"+clic+">"+this[i].txt+"</DIV>";
				}
				else
				{
					A+="<DIV id='"+this.nom+i+"' style='position:absolute;left:"+X+";top:"+Y+";"+style+"width:"+this[i].larg+";height:"+this[i].hauteur+";background-color:"+this.colBarre+";"+this.cssTexte+";color:"+this.colTextOff+";text-align:center;' onmouseover='"+this.nom+".start("+i+","+X+","+(Y+this[i].hauteur+1)+")'"+clic+">"+this[i].txt+"</DIV>";
				}
			}
		}
		if (document.layers)
...
function AFF()
{
	...
	if ((document.all)||(window.sidebar)||(!document.layers))
	{
		//A="<DIV id='"+this.nom+"fond' style='position:absolute;border=1px;top:10;left:100;width:500;height:400;visibility:hidden;font-family:"+font+"' onmouseover='"+this.nom+".onfond()'></DIV>";
		//A+="<DIV id='"+this.nom+"niv0' style='position:absolute;top:10;left:100;visibility:hidden;font-family:"+font+"'></DIV>";
		//A+="<DIV id='"+this.nom+"niv1' style='position:absolute;top:10;left:100;visibility:hidden;font-family:"+font+"'></DIV>";
		//A+="<DIV id='"+this.nom+"niv2' style='position:absolute;top:10;left:100;visibility:hidden;font-family:"+font+"'></DIV>";
		//A+="<DIV id='"+this.nom+"niv3' style='position:absolute;top:10;left:100;visibility:hidden;font-family:"+font+"'></DIV>";
		
		A="<DIV id='"+this.nom+"fond' style='position:absolute;border=1px;top:10;left:100;width:500;height:400;visibility:hidden;font-family:"+this.font+"' onmouseover='"+this.nom+".onfond()'></DIV>";
		for (var i=1;i<=this.nb;i++)
		{
			A+="<DIV id='"+this.nom+"niv"+(i-1)+"' style='position:absolute;top:10;left:100;visibility:hidden;font-family:"+this.font+"'></DIV>";
		}
	...
	else
	{
		...
		//A+="<LAYER name='"+this.nom+"niv0' top=200 left=200 visibility=show></LAYER>";
		//A+="<LAYER name='"+this.nom+"niv1' top=200 left=200 visibility=show></LAYER>";
		//A+="<LAYER name='"+this.nom+"niv2' top=200 left=200 visibility=show></LAYER>";
		//A+="<LAYER name='"+this.nom+"niv3' top=200 left=200 visibility=show></LAYER>";
		
		A="<LAYER name='"+this.nom+"fond' width=500 height=600 visibility=hide top=100 left=100 onmouseover='"+this.nom+"onfond()'>&nbsp;</LAYER>";
		for (var i=1;i<=this.nb;i++)
		{
			A+="<LAYER name='"+this.nom+"niv"+(i-1)+"' top=200 left=200 visibility=show></LAYER>";
		}
	}
	document.write(A);
	this.Print();
...
function aff(x,y)
{
	...
	{
		var A=""
		A+=	"<TABLE border=1 cellpadding=0 cellspacing="+MnuCadInt+" style='"
		...
		for (var i=0;i<this.nb;i++)
		{
			...
			{
				A += "	<TR>"
				A += "		<TD style='font-size:10px;border-style:none;margin:0px;height:"+(5)+"px ' colspan=2>"
				A += "			<DIV  style='background-color:"+this.mainmenu.colFond+";height:"+(5)+"px'>"
				A += "				<HR noshade style='color:"+this.mainmenu.colContour+";height:1'>"
				A += "			</DIV>"
				A += "		</TD>"
				A += "	</TR>";
			}
			else
			{
				...
				A += "					width=100% height="+this[i].hauteur+" onmouseover='"+this.nom+".mmover("+i+")' onClick='"+this.nom+".mmclick()' >"
				A += "				<TR>"
				A += "					<TD NOWRAP id='"+niv+"n"+i+"td' style='border-style:solid;border-width:0;' width=100% valign=middle>"
				A += "						<FONT style='margin-left:"+this.mainmenu.MnuMarLib+";"+css+"'>"+this[i].lib+"</FONT>"
				A += "					</TD>"
				A += "					<TD style='border-style:solid;border-width:0;' width=10 align=right valign=middle>"
				A += "						<FONT style='margin-left:"+this.mainmenu.MnuMarLib+";"+css+"'></FONT>"
	...
	if (document.all)
	{
		document.all[niv].innerHTML=A;
		document.all[niv].style.top=Y;
		document.all[niv].style.left=X;
		document.all[niv].style.visibility="visible";
		this.X=X;
		this.Y=Y;
		this.width=document.all[niv].clientWidth;
	}
	if (window.sidebar||document.getElementById)
	{
		document.getElementById(niv).innerHTML=A;
		document.getElementById(niv).style.top=Y;
		document.getElementById(niv).style.left=X;
	...
	if (document.layers)
	{
		document.layers[niv].left=X;
		document.layers[niv].top=Y;
		document.layers[niv].document.write(A);
		document.layers[niv].document.close();
		document.layers[niv].visibility="show";
		this.X=X;
		this.Y=Y;
		this.width=document.layers[niv].clip.width;
